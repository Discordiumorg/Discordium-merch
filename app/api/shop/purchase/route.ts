...
const ITEMS: Record<string, {
  ...
  'coins-2000': { name: '2000 Coins',  price: 9.99,  coins: 2000 },
  'coins-5000': { name: '5000 Coins',  price: 19.99, coins: 5000 },
  // Boosts
  'boost-1':    { name: '1 Boost',     price: 3.99,  boosts: 1 },
  'boost-5':    { name: '5 Boosts',    price: 14.99, boosts: 5 },
  'boost-15':   { name: '15 Boosts',   price: 19.99, boosts: 15 },
  'boost-night':{ name: 'Night Boost', price: 5.99,  boosts: 3 },
  // Super Likes
  'superlikes-5':  { name: '5 Super Likes',  price: 4.99,  superLikes: 5 },
  'superlikes-25': { name: '25 Super Likes', price: 14.99, superLikes: 25 },
  'superlikes-60': { name: '60 Super Likes', price: 29.99, superLikes: 60 },
  // Roses
  'roses-1':    { name: '1 Rose',       price: 1.99,  roses: 1 },
  'roses-6':    { name: '6 Roses',      price: 9.99,  roses: 6 },
  'roses-24':   { name: '24 Roses',     price: 24.99, roses: 24 },
  // Diamonds
  ...
  // Bundles
  'bundle-starter':  { name: 'Starter Pack',    price: 7.99,  coins: 500,  boosts: 2, superLikes: 10 },
  'bundle-weekend':  { name: 'Weekend Warrior',  price: 14.99, coins: 1000, boosts: 5, superLikes: 20, roses: 3 },
  'bundle-vip':      { name: 'VIP Pack',         price: 29.99, coins: 3000, boosts: 15, superLikes: 50, roses: 10, diamonds: 100 },
  // Premium
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const [user] = await (prisma as any).$transaction([
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
